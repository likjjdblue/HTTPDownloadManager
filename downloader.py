...
#            print ('Cloced file object')
    ...
    def __DisplaySpeed(self):
        ...
        while True:
            ...
            Result=Result+'   '+str(self.TotalIncomeBytes)+'   '+str(self.TotalByteOfDownloaded)+'@'+str(self.TotalBytes)
...
### https://artifacts.elastic.co/downloads/kibana/kibana-5.1.2-linux-x86_64.tar.gz

if __name__=='__main__':
    Tmp=Downloader('https://github.com/git-for-windows/git/releases/download/v2.11.0.windows.3/Git-2.11.0.3-64-bit.exe')
    Tmp.Run()